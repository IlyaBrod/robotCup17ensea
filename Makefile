...
GCC_BIN = 
PROJECT = ROBOT_PROG
OBJECTS = main.o Lidar/Maths/MapAnalyser.o Lidar/Maths/triangulation.o Lidar/Maths/Balise.o Lidar/Sensor/PwmStepMotor.o Motorisation/RobotClaw.o General/GeneralItem.o General/Point.o General/myMaths.o PathFinding/Pathfinding.o PathFinding/Treenode_pathfinding.o PathFinding/Map.o
