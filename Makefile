...
OBJECTS = main.o Lidar/Sensor/PwmStepMotor.o Lidar/Lidar.o Lidar/Maths/MapAnalyser.o Lidar/Maths/triangulation.o Lidar/Maths/Settings.o Lidar/Maths/Balise.o General/Servo.o General/GeneralItem.o General/Point.o General/myMaths.o Motorisation/RobotClaw.o Robot/RobotSecondaire.o Robot/Robot.o Robot/RobotPrincipal.o PathFinding/obsCarr.o PathFinding/Map.o Odometry/Odometry.o
