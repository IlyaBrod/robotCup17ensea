...
GCC_BIN = 
PROJECT = ROBOT_PROG
OBJECTS = main.o GeneralFunctions.o Lidar/Maths/MapAnalyser.o Lidar/Maths/triangulation.o Lidar/Maths/Balise.o Lidar/Sensor/PwmStepMotor.o General/GeneralItem.o General/Point.o General/myMaths.o
